...
def stat_ipopt( data, A,b,c,length_edge,graph_rep):
    ...
    if graph_rep == True:
        ...
        graphical_rep(data,statsol,ub,d,gamma, 10,graph_title = "Static approach")
    
    
    return statsol,x,nb,nc,obj,result,ampl
